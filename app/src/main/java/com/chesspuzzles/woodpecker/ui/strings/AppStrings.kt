...
data class AppStrings(
    ...
    val statsCompletedCycles: String,
    val statsAvgAccuracy: String,
    val statsBestAccuracy: String,
    val statsAvgTimePerPuzzle: String,
    val statsCurrentStreak: String,
    val statsSolvedToday: String,
    val statsSuites: String,
    val statsDays: String,
...
val DeStrings = AppStrings(
    ...
    statsCompletedCycles = "Zyklen",
    statsAvgAccuracy = "Ø Genauigkeit",
    statsBestAccuracy = "Beste Genauigkeit",
    statsAvgTimePerPuzzle = "Ø pro Aufgabe",
    statsCurrentStreak = "Aktuelle Serie",
    statsSolvedToday = "Heute gelöst",
    statsSuites = "Suites",
    statsDays = "Tage",
...
val EnStrings = AppStrings(
    ...
    statsCompletedCycles = "Cycles",
    statsAvgAccuracy = "Avg Accuracy",
    statsBestAccuracy = "Best Accuracy",
    statsAvgTimePerPuzzle = "Avg per Puzzle",
    statsCurrentStreak = "Current Streak",
    statsSolvedToday = "Solved Today",
    statsSuites = "Suites",
    statsDays = "days",
